...
from lightprop.calculations import H_on_axis, get_gaussian_distribution
...
if __name__ == "__main__":
    ...
    kernel = np.array(
        [
            [
                H_on_axis(
                    params.distance / np.sqrt(x**2 + params.distance**2) / params.wavelength,
                    params.distance / np.sqrt(params.distance**2 + y**2) / params.wavelength,
                    params.distance,
                    params.wavelength,
                )
